    ...
    if((accion == 1 || accion == 0) && accion != null && accion != undefined && accion != ""){
        ...
        firebase.auth().onAuthStateChanged((user) => {
            if (user) {
                ...
                var skins =  ["goku.gif","kirby.gif","sonic.gif","picachu.gif","mario.gif","pacman.gif","basketballpelota.png","futbolpelota.png","fitnesspelota.png","marte.png","tennispelota.png"];
